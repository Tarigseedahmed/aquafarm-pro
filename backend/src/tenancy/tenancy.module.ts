...
import { TenantCacheMetricsExporter } from './tenant-cache.metrics';
...
@Module({
  ...
  providers: [
    ...
    AdminGuard,
    TenantCodeCacheService,
    TenantCacheMetricsExporter,
  ],
  exports: [TenantsService, TenantCodeCacheService],
})
